...
(deftest consume-first-event-test
  (is
   (= #:auto-sim.simulation-engine{:id 4
                                   ...
                                   :future-events []}
      (-> #:auto-sim.simulation-engine{:stopping-causes []
                                       :snapshot #:auto-sim.simulation-engine{:id 3
                                                                              :iteration 3
                                                                              :date 10
                                                                              :state {}
                                                                              :past-events []
  ...
  (is (empty? (-> #:auto-sim.simulation-engine{:stopping-causes []
                                               :snapshot #:auto-sim.simulation-engine{:id 3
                                                                                      :iteration 3
                                                                                      :date 1
                                                                                      :state {}
...
(deftest add-current-event-to-stopping-causes-test
  (is (= #:auto-sim.simulation-engine{:stopping-causes
                                      [#:auto-sim.simulation-engine{:a :b
                                                                    :current-event event-stub}
                                       #:auto-sim.simulation-engine{:c :d
                                                                    :current-event event-stub}]
                                      :snapshot nil}
         (sut/add-current-event-to-stopping-causes
          #:auto-sim.simulation-engine{:stopping-causes [#:auto-sim.simulation-engine{:a :b}
                                                         #:auto-sim.simulation-engine{:c :d}]
                                       :snapshot nil}
          event-stub))))
