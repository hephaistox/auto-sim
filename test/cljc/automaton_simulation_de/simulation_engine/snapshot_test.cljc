  ...
  (testing
    ...
    (is
     (= #:auto-sim.simulation-engine{:id 2
                                     ...
                                     :date 7
                                     :state {:foo :bar}
                                     :past-events [#:auto-sim.simulation-engine{:type :a
                                                                                :date 1}
                                                   #:auto-sim.simulation-engine{:type :c
                                                                                :date 7}]
                                     :future-events [#:auto-sim.simulation-engine{:type :b
                                                                                  :date 12}]}
        (sut/consume-first-event
         #:auto-sim.simulation-engine{:id 1
                                      ...
                                      :past-events [#:auto-sim.simulation-engine{:type :a
                                                                                 :date 1}]
                                      :future-events [#:auto-sim.simulation-engine{:type :c
                                                                                   :date 7}
                                                      #:auto-sim.simulation-engine{:type :b
                                                                                   :date 12}]}))))
  (testing "nil current-event is ok"
    (is (= #:auto-sim.simulation-engine{:id 2
                                        :iteration 2
                                        :date 3
                                        :state {:foo :bar}
                                        :past-events [#:auto-sim.simulation-engine{:type :a
...
(deftest inconsistency?-test
    ...
    (is (false? (sut/inconsistency?
                 #:auto-sim.simulation-engine{:date 5
                                              :future-events [#:auto-sim.simulation-engine{:type :b
                                                              ...
                                                              #:auto-sim.simulation-engine{:type :b
                                                                                           :date 5}]
                                              :past-events [#:auto-sim.simulation-engine{:type :b
                                                                                         :date 4}
                                                            #:auto-sim.simulation-engine{:type :a
                                                                                         :date
                                                                                         5}]}))))
  (testing "Too early future events are returned as inconsistency"
    (is (= {:snapshot-date 2
            :mismatching-events #:auto-sim.simulation-engine{:future-events
                                                             [#:auto-sim.simulation-engine{:type :a
                                                                                           :date 1}]
                                                             :past-events []}}
           (sut/inconsistency? #:auto-sim.simulation-engine{:date 2
                                                            :future-events
                                                            [#:auto-sim.simulation-engine{:type :b
                                                                                          :date 20}
                                                             #:auto-sim.simulation-engine{:type :a
  ...
  (testing "Too late past events are returned as inconsistency"
    (is (= {:snapshot-date 2
            :mismatching-events
            #:auto-sim.simulation-engine{:past-events [#:auto-sim.simulation-engine{:type :b
                                                                                    :date 20}]
                                         :future-events []}}
           (sut/inconsistency?
